// main svg
    var svg = d3.select("svg"),
            ...
            g = svg.append("g").attr("transform", "translate(100,50)");       // move right 20px.

    // x-scale and x-axis
    var experienceName = ["", "100","200","300","400","500"];
    ...
    d3.csv("files/mobiledata.csv", row, function(error, data) {
        ...
        leafNodeG.append("rect")
                ...
                .transition()
                    .duration(800)
                    .attr("width", function (d) {var length = xScale((d.data.value/100)); return length;});
